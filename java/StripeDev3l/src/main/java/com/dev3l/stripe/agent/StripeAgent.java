package com.dev3l.stripe.agent;
...
import com.dev3l.stripe.bean.StripeBean;
import com.dev3l.stripe.properties.StripePropertiesSingleton;
...
public class StripeAgent {
	...
	public Charge charge(final StripeBean stripeBean) {
		...
		Stripe.apiKey = StripePropertiesSingleton.getStripePropertiesBeanInstance().getStripeApiKey();
