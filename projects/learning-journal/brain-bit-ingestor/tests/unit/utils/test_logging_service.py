...
from ingestor.utils.logging_service import LoggingService, default_logging_format, default_level
...
@patch('ingestor.utils.logging_service.LoggingService._build_stream_handler')
@patch('ingestor.utils.logging_service.logging')
